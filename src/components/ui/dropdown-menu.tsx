...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      // ⬇️ already fine, but keep high z-index for sub-menus too
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        // ✅ GLOBAL FIX: force dropdown above everything
        "z-[100] max-h-[var(--radix-dropdown-menu-content-available-height)]",
